        ...
        <section>
            <Element name="pricing">
                <div className="container">
                    <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 border-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                        ...
                        <div className="pricing-bg">
                            ...
                            <img src="/images/bg-outlines-fill.png" width={960} height={380} alt="outline" className="absolute inset-0 opacity-5" />
                        </div>
                    </div>
                                ...
                                <ul className="mx-auto space-y-4 xl:px-7">
                                    {plan.features.map((feature) => (
                                        <li key={feature} className="relative flex items-center gap-5">
                                            <img src="/images/check.png" className="size-10 object-contain" alt="check" />
